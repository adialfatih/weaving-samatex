										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<?php 
													if($val->lokasi_saat_ini==$dep_user){
													if($dep_user!='Pusatex') { ?>
													<a class="dropdown-item" href="javascript:void(0);" onclick="send('<?=$val->kode_produksi;?>','<?=$val->kode_konstruksi;?>','<?=$val->tgl_produksi;?>','<?=$val->lokasi_produksi;?>','jml_ins','Pusatex')" data-toggle="modal" data-target="#Medium-modal"
														><i class="dw bi bi-send"></i> Kirim Pusatex</a
													><?php } if($dep_user!='Samatex') {?>
													<a class="dropdown-item" href="javascript:void(0);" onclick="send('<?=$val->kode_produksi;?>','<?=$val->kode_konstruksi;?>','<?=$val->tgl_produksi;?>','<?=$val->lokasi_produksi;?>','jml_ins','Samatex')" data-toggle="modal" data-target="#Medium-modal"
													...
													><a class="dropdown-item" href="javascript:void(0);" onclick="retur('<?=$val->kode_produksi;?>','<?=$val->lokasi_saat_ini;?>')" data-toggle="modal" data-target="#Medium-modal4"
										...
										<div class="modal-content">
											...
											<div class="modal-body">
													...
													<div class="form-group row">
														...
														<div class="col-sm-12 col-md-10">
															<input class="form-control" type="number" placeholder="Masukan jumlah produksi" name="jmlproduksi" min="0" oninput="this.value = Math.abs(this.value)" step="0.01" required
															/>
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-sm-12 col-md-10">
															<div class="custom-control custom-checkbox" style="display:flex;">
																<div>
																<input type="checkbox" class="custom-control-input" id="customCheck1" onclick="inspect()" name="status" value="Inspect"
																/>
																...
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<div>
																<input type="checkbox" class="custom-control-input" id="customCheck2" onclick="folding()" name="status" value="Folding"
																/>
													...
													<!-- <div class="form-group row">
														...
														<div class="col-sm-12 col-md-10"> -->
															<input class="form-control" type="hidden" value="0" placeholder="Masukan jumlah mesin" name="jmlmesin" min="0" oninput="this.value = Math.abs(this.value)" required />
														<!-- </div>
													</div> -->
													<div class="form-group row">
														<label class="col-sm-12 col-md-2 col-form-label">Keterangan</label>
														<div class="col-sm-12 col-md-10">
															<input class="form-control" type="text" placeholder="Masukan keterangan" name="ket" />
														</div>
													</div>
...
<script>
	...
	function send(kdp,kdk,tgl,loc,jml,ke){
		...
		document.getElementById("dinamic_jml").innerHTML = '<strong>'+jml+'</strong>';
