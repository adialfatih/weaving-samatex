				...
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						<div class="pd-20">
							<p class="mb-0">
								INSPECT FINISH
							</p><small>Input melalui form ini akan di anggap sebagai proses inspect finish stok lama</small>
						</div>
						<div class="pd-20 card-box mb-30">
                            <div class="clearfix">
                                <?php echo form_open_multipart('phpsp/importif',array('name' => 'spreadsheet')); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10" style="display:flex;align-items:center;">
                                            <input class="form-control" style="width:200px;" placeholder="Jumlah produksi (yard)" type="text" name="jumlah" required> &nbsp; <em><small>Yard</small></em>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <hr>
                                    <a href="<?=base_url('phpsp/exportif/'.$kdp.'');?>">
