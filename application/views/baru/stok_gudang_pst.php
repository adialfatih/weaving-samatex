			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						...
						<div class="pb-20">
							<table class="data-table table stripe hover nowrap">
								...
								<tbody>
                                <?php 
								$qr1 = $this->db->query("SELECT * FROM data_stok WHERE dep='Samatex-IN-Pusatex'");
					...
					<div class="card-box mb-30">
						...
						<div class="pb-20">
							<table class="data-table table stripe hover nowrap">
								...
								<tbody>
                                <?php 
								$qr1 = $this->db->query("SELECT * FROM data_stok WHERE dep='RJS-IN-Pusatex'");
								$no=1; foreach($qr1->result() as $n => $val):
                    ...
                    <div class="card-box mb-30">
						<div class="pd-20">
							<p class="mb-0">
							<strong>Stok Gudang (Stok Lama Tanpa Kode)</strong>
							</p>
						</div>
						<div class="pb-20">
							<table class="data-table table stripe hover nowrap">
								...
								<tbody>
                                <?php $no=1; foreach($tbdata2->result() as $n => $val):
									...
									<tr>
										...
										<td>
											<?php 
												...
												echo $ukuran;
                                                if($val->st_folding=="Grey") {echo " meter";} else {echo " yard";}
											?>
										</td>
