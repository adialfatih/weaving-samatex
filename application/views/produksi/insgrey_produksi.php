                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="javascript:;" style="color:blue;" title="Edit Data" onclick="editdata('<?=$val->kode_roll;?>','<?=$val->konstruksi;?>','<?=$val->no_mesin;?>','<?=$val->no_beam;?>','<?=$val->oka;?>','<?=$val->ukuran_ori;?>','<?=$val->ukuran_bp;?>','<?=$val->ukuran_bs;?>')" data-toggle="modal" data-target="#Medium-modal2">
                                            ...
                                            &nbsp;
                                            <a href="javascript:;" style="color:red;" onclick="chdata('<?=$val->id_data;?>','<?=$val->kode_roll;?>','<?=$val->konstruksi;?>')" title="Hapus Data" data-toggle="modal" data-target="#Medium-modal">
...
<script>
    function chdata(idd,kd,kons){
        ...
        document.getElementById('kdroll1').value = ''+idd;
    }
