        ...
        $.ajax({
          ...
          success: function(dataResult){
              ...
              if(dataResult.statusCode==200){
                  //console.log('nilai='+dataResult.psn);
                  //console.log('nextoke'+value);
                  var nilai = $('#idpilihan').val();
                  var psfnilai = parseFloat(nilai);
                  var psfpsn = parseFloat(dataResult.psn);
                  var rndnilai = roundToTwo(psfnilai);
                  var rndpsn = roundToTwo(psfpsn);
                  var kurangi = rndnilai + rndpsn;
                  var rnkurangi = roundToTwo(kurangi);
                  $('#footss').html('Jumlah penjualan : <strong>'+rnkurangi+'</strong>');
                  $('#idpilihan').val(''+rnkurangi);
                  $('#idjumlahawal').html(''+rnkurangi);
